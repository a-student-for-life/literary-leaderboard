  ...
  <div className="mt-1 flex justify-center sm:justify-start items-center gap-4">
    ...
    >
      <FaInstagram size={24} />
          ...
          <div className="mt-2 h-1 w-24 bg-[#C35B3A] rounded-full mx-auto sm:mx-0" />
        </div>
      </div>
      ...
      {/* Leaderboard section title */}
      <h2 className="text-xl sm:text-2xl font-serif font-bold mb-4 text-center text-dark-brown tracking-tight">
        Leaderboard — Prose & Poetry
      </h2>
